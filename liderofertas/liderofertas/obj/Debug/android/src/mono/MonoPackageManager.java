...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "liderofertas.dll" comes first in this list. */
		"liderofertas.dll",
		"Apps.Common.Models.dll",
		"Apps.Common.Services.dll",
		"Apps.Common.Utils.dll",
		"Estimote.Android.Proximity.dll",
		"Lottie.Android.dll",
