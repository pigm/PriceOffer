...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("liderofertas.AppUtils.MascarasTextWatcher, liderofertas", MascarasTextWatcher.class, __md_methods);
	}
	...
	public MascarasTextWatcher ()
	{
		...
		if (getClass () == MascarasTextWatcher.class)
			mono.android.TypeManager.Activate ("liderofertas.AppUtils.MascarasTextWatcher, liderofertas", "", this, new java.lang.Object[] {  });
	}
	...
	public MascarasTextWatcher (android.widget.EditText p0, android.app.Activity p1, int p2)
	{
		super ();
		if (getClass () == MascarasTextWatcher.class)
			mono.android.TypeManager.Activate ("liderofertas.AppUtils.MascarasTextWatcher, liderofertas", "Android.Widget.EditText, Mono.Android:Android.App.Activity, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
