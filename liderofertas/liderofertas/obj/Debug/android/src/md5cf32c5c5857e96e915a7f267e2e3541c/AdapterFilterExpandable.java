...
public class AdapterFilterExpandable
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("liderofertas.AppAdapters.AdapterFilterExpandable, liderofertas", AdapterFilterExpandable.class, __md_methods);
	}


	public AdapterFilterExpandable ()
	{
		super ();
		if (getClass () == AdapterFilterExpandable.class)
			mono.android.TypeManager.Activate ("liderofertas.AppAdapters.AdapterFilterExpandable, liderofertas", "", this, new java.lang.Object[] {  });
	}

	public AdapterFilterExpandable (android.app.Activity p0, android.support.v4.app.FragmentManager p1)
	{
		super ();
		if (getClass () == AdapterFilterExpandable.class)
			mono.android.TypeManager.Activate ("liderofertas.AppAdapters.AdapterFilterExpandable, liderofertas", "Android.App.Activity, Mono.Android:Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.Fragment", this, new java.lang.Object[] { p0, p1 });
	}
