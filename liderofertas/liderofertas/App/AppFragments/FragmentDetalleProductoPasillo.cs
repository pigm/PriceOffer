...
{
    /// <summary>
    /// Fragment detalle producto pasillo.
    /// </summary>
    public class FragmentDetalleProductoPasillo : Android.Support.V4.App.Fragment
    {
        AdapterProductoRelacionadoPasillo adapter;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:liderofertas.AppFragments.FragmentDetalleProductoPasillo"/> class.
        /// </summary>
        /// <param name="fm">Fm.</param>
        public FragmentDetalleProductoPasillo(FragmentManager fm) { this.fm = fm; }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            llBtnClose.Click += delegate { Activity.Finish(); };
            DetalleProductoPasilloPresenter.ProductoDetalle(llPanelConProducto, llPanelSinProducto, Activity, imgProductoDetalle, lblNombreProducto, lblMarcaCategoria, lblPrecioOferta, sheet_suc);
            List<ProductoModelAndroid> filtroProductosCategoria = new List<ProductoModelAndroid>();
            if (AndroidDataManager.ProductosXsubcategoria != null)
            {
                filtroProductosCategoria = AndroidDataManager.ProductosXsubcategoria.ToList();
            }
            else
            {
                filtroProductosCategoria = AndroidDataManager.TotalProductosPasillo;
            }
            ...
            adapter = new AdapterProductoRelacionadoPasillo(filtroProductosCategoria, this);
        ...
        void OnItemClick(object sender, List<Object> e) { StartActivity(new Intent(Activity, typeof(DetalleProductoPasilloActivity))); }
    }
}
